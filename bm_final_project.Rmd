...
2. predicators: 4 continuous; 10 categorical</font>
...
# density for other variables
par(mfrow=c(2,3))
heart_df |> 
  mutate(lnrnp = log(rnp)) |> 
  ggplot(aes(x = lnrnp))+geom_density()
boxplot(heart_df$survival_months, main='survival_months')
boxplot(heart_df$age, main='age')
boxplot(heart_df$tumor_size, main='tumor_size')
boxplot(heart_df$rne, main='rne')
...
<font color = "blue">most data are right-skewed</font>
